...
class FaqsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWithActionButton(title: StringsConstants.faqs.tr()),
...
//                           Transform.flip(
//                             flipY: false,
//                             child: SvgPicture.asset(IconsConstants.arrowUpIC),
//
//                           )
//                         ],
//                       ),
...
// nostrud exercitation ullamco laboris nisi ut aliquip""",style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: FontSize.s14,height: 3)),
